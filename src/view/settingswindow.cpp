...
void SettingsWindow::selectWorkingRate( int rate )
{
    ...
    switch( rate )
    {
        ...
        case HelperWT::Hours_40_Lanch:
            InfoWorkingRate = tr("<center><b><u>Рабочее время: 40 часов в неделю.</u></b></center><br/>"\
                                 "С понедельника по четверг рабочий день 9:00, в пятницу - 8:00.<br/>"\
                                 "Время обеда уже включено во время рабочего дня.");
        break;

        case HelperWT::Hours_40_NoLanch:
            InfoWorkingRate = tr("<center><b><u>Рабочее время: 40 часов в неделю.</u></b></center><br/>"\
                                 "С понедельника по четверг рабочий день 8:15, в пятницу - 7:00.<br/>"\
                                 "Время обеда высчитывается: если вы начали рабочий день ранее " \
                                 "времени начала обеда (см. настройки->время), то время обеда "\
                                 "(45 минут по умолчанию) будет автоматически добавлено ко времени "
                                 "рабочего дня. Если у вас были интервалы в промежутке обеда, то "
                                 "время рабочего дня уменьшится, но не меньше, чем на 45 минут.");
        break;

        case HelperWT::Hours_40_4_Days:
            InfoWorkingRate = tr("<center><b><u>Рабочее время: 40 часов в неделю.</u></b></center><br/>"\
                                 "Понедельник, вторник и четверг - 10:15, пятница: 09:15. Среда - выходной.<br/>"\
                                 "Время обеда высчитывается: если вы начали рабочий день ранее " \
                                 "времени начала обеда (см. настройки->время), то время обеда "\
                                 "(45 минут по умолчанию) будет автоматически добавлено ко времени "
                                 "рабочего дня. Если у вас были интервалы в промежутке обеда, то "
        ...
        case HelperWT::Hours_35_NoLanch:
            InfoWorkingRate = tr("<center><b><u>Рабочее время: 35 часов в неделю.</u></b></center><br/>"\
                                 "С понедельника по пятницу: 07:00, время обеда не включено.<br/>"\
                                 "Время обеда высчитывается: если вы начали рабочий день ранее " \
                                 "времени начала обеда (см. настройки->время), то время обеда "\
                                 "(45 минут по умолчанию) будет автоматически добавлено ко времени "
                                 "рабочего дня. Если у вас были интервалы в промежутке обеда, то "
        ...
        case HelperWT::Hours_30_NoLanch:
            InfoWorkingRate = tr("<center><b><u>Рабочее время: 30 часов в неделю.</u></b></center><br/>"\
                                 "С понедельника по пятницу: 06:00, время обеда не включено.<br/>"\
                                 "Время обеда высчитывается: если вы начали рабочий день ранее " \
                                 "времени начала обеда (см. настройки->время), то время обеда "\
                                 "(45 минут по умолчанию) будет автоматически добавлено ко времени "
                                 "рабочего дня. Если у вас были интервалы в промежутке обеда, то "
        ...
        case HelperWT::Hours_20_NoLanch:
            InfoWorkingRate = tr("<center><b><u>Рабочее время: 20 часов в неделю.</u></b></center><br/>"\
                                 "С понедельника по пятницу: 04:00<br/>"\
                                 "Обед с такой рабочей ставкой не предусмотрен.");
        break;
